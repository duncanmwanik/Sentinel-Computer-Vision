...
from website.counter.centroidtracker import *
from website.counter.trackableobject import *
...
# -------------Counter CV2 Code-----------------------------------END


# -------------Class to Process Each Channel's Video-----------------------------------START
class ChanFeed:
    def __init__(self, name, url, cc, usd):
        self.name = name
        self.url = url
        self.cc = True if cc == 'True' else False
        self.usd = usd
        ...
        while True:
            ...
            if not success:
                ...
                if self.cc == True:
                    ...
                    data = {'entry': totalDown, 'exit': totalUp}
                    path = self.usd + "/counter/logs/" + date + "/" + self.name + '/'
